...
<div align="center"><img src="./图/图4-2 修改后的星探寻找美女类图.png" width="500px"></div>
...
* 接口要尽量小
  ...
  <div align="center"><img src="./图/图4-3 电话类图.png" width="500px"></div>
...
* 定制服务
  ...
  <div align="center"><img src="./图/图4-4 图书查询类图.png" width="250px"></div>
  ...
  <div align="center"><img algin="center" src="./图/图4-5 修改后的图书查询类.png" width="500px"></div>
...
* 只和**朋友类**交流
  ...
  **朋友类**就是出现在成员变量、方法的输入输出参数中的类。出现在方法体内部的类不属于朋友类。
  ...
  <div align="center"><img src="./图/图5-1 老师要求清点女生类图.png" width="400px"></div>
  ...
  **迪米特法则要求一个类只和朋友类交流，但command方法却和Girl类有了交流**。
  ...
  <div align="center"><img src="./图/图5-2 修改后的类图.png" width="400px"></div>
